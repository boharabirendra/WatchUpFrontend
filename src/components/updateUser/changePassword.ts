...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const changePasswordFormElement = document.getElementById(
    "change-password-form"
  ) as HTMLFormElement;
  const changePasswordMessageElement = document.getElementById(
  ...
  changePasswordFormElement.addEventListener("submit", async (event) => {
    ...
    if (newPassword !== confirmPassword) {
        ...
        changePasswordMessageElement.innerHTML =
